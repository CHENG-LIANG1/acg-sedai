...
export const YearTableRow = React.memo(
  React.forwardRef<HTMLTableRowElement, YearTableRowProps>(function YearTableRow(
    { group, groupIndex, isWatched, toggleWatched },
    ref,
  ) {
